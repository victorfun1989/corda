...
val MEGA_CORP: Party get() = getTestParty(X509Utilities.getDevX509Name("MegaCorp"), MEGA_CORP_PUBKEY)
val MINI_CORP: Party get() = getTestParty(X509Utilities.getDevX509Name("MiniCorp"), MINI_CORP_PUBKEY)

val BOC_KEY: KeyPair by lazy { generateKeyPair() }
val BOC_PUBKEY: PublicKey get() = BOC_KEY.public
val BOC: Party get() = getTestParty(getTestX509Name("BankOfCorda"), BOC_PUBKEY)
...
val BIG_CORP: Party get() = getTestParty(X509Utilities.getDevX509Name("BigCorporation"), BIG_CORP_PUBKEY)
