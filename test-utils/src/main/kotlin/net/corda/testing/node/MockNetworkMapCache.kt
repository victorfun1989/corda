...
class MockNetworkMapCache : InMemoryNetworkMapCache() {
    private companion object {
        val BANK_C = getTestParty(getTestX509Name("Bank C"), entropyToKeyPair(BigInteger.valueOf(1000)).public)
        val BANK_D = getTestParty(getTestX509Name("Bank D"), entropyToKeyPair(BigInteger.valueOf(2000)).public)
    }
